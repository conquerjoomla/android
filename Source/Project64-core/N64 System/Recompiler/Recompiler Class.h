...
public:
    ...
    void ClearRecompCode_Virt ( uint32_t VirtualAddress, int length, REMOVE_REASON Reason );
    void ClearRecompCode_Phys ( uint32_t PhysicalAddress, int length, REMOVE_REASON Reason );
