...
public:
    ...
    bool Initiate(CN64System * System, void * RenderWindow);

    void(__cdecl *CaptureScreen)      (const char *);
    void(__cdecl *ChangeWindow)       (void);
    void(__cdecl *DrawScreen)         (void);
    void(__cdecl *DrawStatus)         (const char * lpString, int RightAlign);
    ...
    void(__cdecl * OnRomBrowserMenuItem) (int MenuID, void * hParent, uint8_t * HEADER);
