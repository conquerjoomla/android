 ...
 * ,
    FirstRSPDefaultSet, 
    LastRSPDefaultSet = FirstRSPDefaultSet + 65535,
    FirstRSPSettings, 
    LastRSPSettings = FirstRSPSettings + 65535,
    FirstGfxDefaultSet, 
    LastGfxDefaultSet = FirstGfxDefaultSet + 65535,
    FirstGfxSettings, 
    LastGfxSettings = FirstGfxSettings + 65535,
    FirstAudioDefaultSet, 
    LastAudioDefaultSet = FirstAudioDefaultSet + 65535,
    FirstAudioSettings, 
    LastAudioSettings = FirstAudioSettings + 65535,
    FirstCtrlDefaultSet, 
    LastCtrlDefaultSet = FirstCtrlDefaultSet + 65535,
    FirstCtrlSettings, LastCtrlSettings = FirstCtrlSettings + 65535,
    */
    ;
    private int value;
