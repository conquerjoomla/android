 ...
 * You can optionally modify the behavior of GLSurfaceView2 by calling
...
public class GLSurfaceView2 extends SurfaceView implements SurfaceHolder.Callback {
    private final static String TAG = "GLSurfaceView2";
    ...
    /**
     * Log GL calls to the system log at "verbose" level with tag "GLSurfaceView2".
     *
     * @see #getDebugFlags
     * @see #setDebugFlags
     */
    ...
    private abstract class BaseConfigChooser
        ...
        private int[] filterConfigSpec(int[] configSpec) {
            ...
            int[] newConfigSpec = new int[len + 1];
            ...
            //}
            newConfigSpec[len] = EGL10.EGL_NONE;
    ...
    private final WeakReference<GLSurfaceView2> mThisWeakRef =
            new WeakReference<GLSurfaceView2>(this);
